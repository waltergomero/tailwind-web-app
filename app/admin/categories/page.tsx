      ...
      <div className="mb-2">
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gray-700 text-white text-sm rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors whitespace-nowrap"
          >
